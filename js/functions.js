...
function timeElapse(c) {
	...
	if (n > 0) {
		var a = '<span class="digit">' + n + '</span>&nbsp;&nbsp;年&nbsp;&nbsp;<span class="digit">' + g + '</span>&nbsp;&nbsp;天&nbsp;&nbsp;<span class="digit">' + b + '</span>&nbsp;&nbsp;时&nbsp;&nbsp;<span class="digit">' + d + '</span>&nbsp;&nbsp;分&nbsp;&nbsp;<span class="digit">' + f + "</span>&nbsp;&nbsp;秒";
		$("#elapseClock").html(a)
	} else {
...
function showMessages() {
	adjustWordsPosition();
	var love_div = document.getElementById('love')
	love_div.className = 'love';
...
function adjustWordsPosition() {
	...
	$('#img').css('justify-content','space-between')
}
